...
{
    {
        ...
        RenderSimpleMesh(meshes["sphere"], shaders["LabShader"], modelMatrix, glm::vec3(0.24f, 0.24f, 0.85f));
    }
...
void Lab7::RenderSimpleMesh(Mesh *mesh, Shader *shader, const glm::mat4 & modelMatrix, const glm::vec3 &color)
{
    ...
    GLint locationLight = glGetUniformLocation(shader->program, "light_position");
    glUniform3fv(locationLight, 1, glm::value_ptr(lightPosition));

    glm::vec3 eyePosition = GetSceneCamera()->m_transform->GetWorldPosition();
    // TODO(student): Set eye position (camera position) uniform
    GLint locationEye = glGetUniformLocation(shader->program, "eye_position");
    ...
    GLfloat locationKd = glGetUniformLocation(shader->program, "material_kd");
    ...
    //glUniform3fv(locationLight, GL_FALSE, glm::value_ptr(lightPosition));
    //glUniform3f(locationColor, 0.25, 0.25, 0.25);
