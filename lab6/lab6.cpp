...
void Lab6::RenderSimpleMesh(Mesh *mesh, Shader *shader, const glm::mat4 & modelMatrix)
{
    ...
    int locationProj = glGetUniformLocation(shader->GetProgramID(), "Projection");
    ...
    int locationTime = glGetUniformLocation(shader->GetProgramID(), "Time");

    // Set shader uniform "Time" to GetElapsedTIme()
