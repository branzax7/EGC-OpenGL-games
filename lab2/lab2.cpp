...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        vector<VertexFormat> vertices
        {
            ...
            VertexFormat(glm::vec3(0, 0,  0), glm::vec3(0, 1, 1)), //4
            VertexFormat(glm::vec3(1, 0,  0), glm::vec3(0, 1, 1)), // 5
            VertexFormat(glm::vec3(0, 1,  0), glm::vec3(0, 1, 1)), //6
            VertexFormat(glm::vec3(1, 1,  0), glm::vec3(0, 1, 1)), //7
        ...
        vector<VertexFormat> vertices3 //tetraedru
        {
            /*VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0, 1, 1)), //0
            VertexFormat(glm::vec3(1, 1, 0), glm::vec3(1, 1, 1)), //1
            VertexFormat(glm::vec3(1, 0, 1), glm::vec3(0.5, 1, 1)), //2
            VertexFormat(glm::vec3(0, 1, 1), glm::vec3(1, 0, 1)), //3
            */
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0, 1, 0)), //0     //0
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0.5, 1, 1)), //1
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(1, 0.5, 1)), //2
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0, 0, 1)), //3

            VertexFormat(glm::vec3(1, 1, 0), glm::vec3(0, 1, 0)), //4     //1
            VertexFormat(glm::vec3(1, 1, 0), glm::vec3(0.5, 1, 1)), //5
            VertexFormat(glm::vec3(1, 1, 0), glm::vec3(1, 0.5, 1)), //6
             VertexFormat(glm::vec3(1, 1, 0), glm::vec3(0, 0, 1)), //7

            VertexFormat(glm::vec3(1, 0, 1), glm::vec3(0, 1, 0)), //8     //2
            VertexFormat(glm::vec3(1, 0, 1), glm::vec3(0.5, 1, 1)), //9
            VertexFormat(glm::vec3(1, 0, 1), glm::vec3(1, 0.5, 1)), //10
            VertexFormat(glm::vec3(1, 0, 1), glm::vec3(0, 0, 1)), //11

            VertexFormat(glm::vec3(0, 1, 1), glm::vec3(0, 1, 0)), //12     //3
            VertexFormat(glm::vec3(0, 1, 1), glm::vec3(0.5, 1, 1)), //13
            VertexFormat(glm::vec3(0, 1, 1), glm::vec3(1, 0.5, 1)), //14
            VertexFormat(glm::vec3(0, 1, 1), glm::vec3(0, 0, 1)), //15
        };
        ...
        vertices4.emplace_back(glm::vec3(0, 0, 0), glm::vec3(1.f, 1.f, 1.f));
        for (GLushort i = 0; i < NUM_TRIANGLES; i++)
        {
            arg = 2*M_PI * i / NUM_TRIANGLES;

            vertices4.emplace_back(glm::vec3(cos(arg), sin(arg), 0), glm::vec3(1.f, 1.f, 0.f));
            indices4.push_back(i);
        }
        indices4.push_back(NUM_TRIANGLES);
        indices4.push_back(1);

        // Create a new mesh from buffer data
        CreateMesh("circle", vertices4, indices4);
        ...
        CreateMesh("tetra", vertices3, indices3);
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["tetra"], shaders["VertexColor"], glm::vec3(-3, 0.5f, 0), glm::vec3(0.25f));

    // TODO(student): Draw the square
    RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(3, 0.5f, 0), glm::vec3(0.25f));
